...
public class WordExporter 
{
	...
	public void exportTest(/*Quiz quiz, Path template, Path destination,*/ boolean isKey) //Can only use isKey for now for testing
	{
		try (XWPFDocument document = new XWPFDocument()) 
		{
            ...
            System.out.println("Quiz exported successfully to " + Paths.get(System.getProperty("user.dir"), "output.docx"));
        } catch (IOException e) {
            e.printStackTrace();
        }
	}
